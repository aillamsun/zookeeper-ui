...
public interface IZkClient extends Closeable {
     ...
     * @throws {@link ZkNoNodeException} if the node not exists
     ...
     * @see {@link #waitForKeeperState(org.apache.zookeeper.Watcher.Event.KeeperState, long, TimeUnit)}
     */
     ...
     * @return the stat for the node
     * @see {@link #cas(String, DataUpdater)}
     */
